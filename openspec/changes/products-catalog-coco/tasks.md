...
### [ ] T1 — `feat(products): coco-ize ProductCard hover + surface`
...
### [ ] T2 — `feat(products): coco-ize ProductCardGrid skeleton`
...
### [ ] T3 — `feat(products): coco-ize ProductUpsertSlideover + CategorySelect + SatKeySelect`
...
### [ ] T4 — `feat(products): coco-ize ProductImageGallery dropzone + star buttons`
...
### [ ] T5 — `feat(products): coco-ize VariantImagePickerModal + PriceListSection`
...
### [ ] T6 — `feat(products): coco-ize ProductDetailView hex migration + CTAs`
...
### [ ] T7 — `feat(products): coco-ize ProductsView section + modal Guardar`
...
### [ ] T8 — `test(products): pin coco tokens + rename dropzone suite`
