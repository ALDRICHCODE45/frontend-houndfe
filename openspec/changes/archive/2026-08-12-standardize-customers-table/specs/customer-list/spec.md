# Delta for `customer-list` — `standardize-customers-table`

Purpose: new capability — no prior spec; `CustomersView.vue` pre-dates the spec system. Standardizes the list to ProductsView parity; all requirements are ADDED.
