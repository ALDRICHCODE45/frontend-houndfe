...
const MEMBERSHIP_ERROR_MAP: Record<string, string> = {
  ...
  TENANT_ACCESS_DENIED: 'No tienes permisos para gestionar esta sucursal',
  INSUFFICIENT_PERMISSIONS_IN_TARGET_TENANT: 'No tienes permisos suficientes para operar en esta sucursal',
