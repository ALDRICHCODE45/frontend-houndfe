import type { MultiEnumFilterDefinition } from '../types'
...
export const multiEnumSerializer = {
  toQuery(value: string[], field: MultiEnumFilterDefinition, includeNull?: boolean): Record<string, string> {
  ...
  fromQuery(query: Record<string, string | string[] | undefined>, field: MultiEnumFilterDefinition): { value: string[], includeNull: boolean } {
    return {
